...
```jsonc
{
  ...
  // 기본 false. true일 때만 hooks/scripts/maestro-router.js를 fallback으로 호출.
...
| 분류가 기대와 다름 | 기본은 extension TS router. legacy hook router 비교가 필요하면 `maestroChat.useLegacyRouter=true` |
